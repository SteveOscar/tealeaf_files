# this code demonstrates how objects taken as parameters in methods are values that are reassigned
# to another a variable, even if that vaiable has the same name.
